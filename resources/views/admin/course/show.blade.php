...
<div class="container mt-4">
    ...
    <div class="row py-4 p-3">
        <h1 class="page-header-title main-font text-light font-weight-bold">Curso "X"</h1>
    </div>
                ...
                <div class="card-body main-font py-4 bg-light">
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Lorem Ipsum" disabled>
                        </div>
                        <div class="form-group">
                            <label for="exampleFormControlTextarea1">Descrição 1 (O que vou aprender neste curso?)</label>
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Lorem Ipsum" disabled></textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="btn btn-success main-font col-lg-3 float-right py-2"><i class="fa fa-print mr-3"></i>Imprimir</div>
                        </div>
                    </form>
                </div>
            </div>
