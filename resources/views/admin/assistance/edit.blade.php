...
<div class="container mt-4">
    ...
    <div class="row py-4 p-3">
        <h1 class="page-header-title main-font text-light font-weight-bold">Editar Consultoria</h1>
    </div>
                ...
                <div class="card-body main-font py-4 bg-light">
                    <form>
                        ...
                        <div class="form-group py-4">
                            <div class="btn btn-primary main-font col-lg-3 float-right py-2">Alterar</div>
                        </div>
                    </form>
                </div>
            </div>
