...
<div class="container mt-4">
    ...
    <div class="row py-4 p-3">
        <h1 class="page-header-title main-font text-light font-weight-bold">Consultoria n° 350</h1>
    </div>
        ...
        <div class="col-xxl-12 col-xl-12 mb-2 py-4">
            <div class="card bg-light">
                <div class="card-body main-font py-4 bg-light">
                    <form>
                        <label for="exampleFormControlSelect1" class="py-4 h1">Data e Horário:</label>
                        ...
                        <label for="exampleFormControlSelect1" class="py-4 h1">Tutor:</label>
                        <div class="form-group row">
                            <div class="col">
                        ...
                        <div class="form-group py-4">
                            <a href="/admin/assistance/edit" class="btn btn-success main-font col-lg-3 float-right py-2">Alterar</a>
                        </div>
                    </form>
                </div>
            </div>
