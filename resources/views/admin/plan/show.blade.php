...
<div class="container mt-4">
    ...
    <div class="row py-4 p-3">
        <h1 class="page-header-title main-font text-light font-weight-bold">Plano Lorem Ipsum</h1>
    </div>
            ...
            <div class="card bg-light">
                <div class="card-body main-font py-4 bg-light">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlSelect1" class="py-4 h1">Descrição:</label>
                            <textarea disabled="" name="#" id="" cols="30" rows="6" class="form-control"></textarea>
                        </div>
                        ...
                        <div class="form-group py-4">
                            <a class="btn btn-success main-font col-lg-2 float-right py-2" href="/admin/plan/edit">Alterar</a>
                        </div>
                    </form>
                </div>
            </div>
