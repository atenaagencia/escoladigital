...
<div class="container mt-4">
    ...
    <div class="row py-4 p-3">
        <h1 class="page-header-title main-font text-light font-weight-bold">Novo Aviso</h1>
    </div>
            ...
            <div class="card bg-light">
                <div class="card-body main-font py-4 bg-light">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlSelect1" class="py-4 h1">Descreva o aviso:</label>
