        ...
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-10 align-self-end">
                <div class="container py-3">
                    <i class="fa fa-wifi fa-5x text-light py-3"></i> <i class="fa fa-plus fa-5x text-light py-3"></i><i class="fas fa-chalkboard-teacher fa-5x text-light py-3"></i>
                </div>
            ...
            <div class="col-lg-8 align-self-baseline">
                ...
                <a class="btn btn-success btn-xl js-scroll-trigger" href="#about">Ver mais</a>
            </div>
        </div>
    </div>
</header>
